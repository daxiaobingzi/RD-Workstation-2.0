...
/** 复盘 tab：记录项目收尾总结（收益/问题/改进，沉淀为文档 type=review_record） */
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
      ...
      <div className="rounded-lg border border-rule bg-surface shadow-sm">
        ...
        <ul className="divide-y divide-rule">
          ...
          {!reviews.length && <li className="py-10 text-center text-[12.5px] text-faint"><EmptyState icon={<Trophy />} title="还没有复盘" description="项目收尾时记录经验，复盘会沉淀为知识（模块 07）" /></li>}
        </ul>
      </div>
